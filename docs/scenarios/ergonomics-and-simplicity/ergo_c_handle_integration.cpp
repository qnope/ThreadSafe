...
// ---- what the library says before any vouch ----
static_assert(!threadsafe::is_synchronizable_v<app::logger>);
static_assert(!threadsafe::is_sendable_v<app::logger>);
static_assert(!threadsafe::is_lifetime_aware_v<app::logger>);
