...
template <>
struct threadsafe::is_sendable<SampleBuffer> : std::true_type {};
template <>
struct threadsafe::is_lifetime_aware<SampleBuffer> : std::true_type {};
template <>
struct threadsafe::is_synchronizable<const SampleBuffer> : std::true_type {};
