...
template <class T>
struct is_synchronizable<const std::allocator<T>> {
    static constexpr TraitAnswer value = {};
};

template <class T>
struct is_lifetime_aware<std::allocator<T>> {
    static constexpr TraitAnswer value = {};
};
...
template <>
struct is_synchronizable<const std::stop_token> {
    static constexpr TraitAnswer value = {};
};

template <>
struct is_synchronizable<const std::stop_source> {
    static constexpr TraitAnswer value = {};
};

template <>
struct is_lifetime_aware<std::stop_token> {
    static constexpr TraitAnswer value = {};
};

template <>
struct is_lifetime_aware<std::stop_source> {
    static constexpr TraitAnswer value = {};
};
